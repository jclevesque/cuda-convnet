...
export CUDA_SDK_PATH=./cuda_samples/inc 

# Python include directory. This should contain the file Python.h, among others.
export PYTHON_INCLUDE_PATH=/usr/include/python2.7
#/software6/apps/python/2.7.5/include/python2.7

# Numpy include directory. This should contain the file arrayobject.h, among others.
export NUMPY_INCLUDE_PATH=/usr/lib/python2.7/dist-packages/numpy/core/include/numpy
#/software6/apps/python/2.7.5/lib/python2.7/site-packages/numpy/core/include/numpy
